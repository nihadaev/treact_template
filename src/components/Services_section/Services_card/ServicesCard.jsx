...
const ServicesCard = (props) => {
    ...
    const { img, header, description } = props.props


    return (
        <div className="services-card">
            <Link className="services-card_link">
                <div className="services-card_head">
                    <span>
                        <img src={img} alt="" />
                    </span>
                </div>
                <div className="services-card_body">
                    <h2 className="black">{header}</h2>
                    <p>{description}</p>
                </div>
                <div className="services-card_foot">
                    <Link>Learn More
